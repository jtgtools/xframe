...
# vecxz 0 0 1 aligns both member directions with the xframe model:
# X-beams get local y along global Y, Y-columns get local y along global X,
# so in-plane (global XY) bending uses Iz in both codes, matching the xframe
# orientations ([0, 1, 0] for beams, [1, 0, 0] for columns).
...
element elasticBeamColumn 2 2 3 0.015 200.0e9 76.92307692307692e9 6.0e-6 7.0e-6 12.0e-6 1
