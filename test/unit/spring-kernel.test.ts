...
describe("spring kernels", () => {
  it("ground spring uses explicit six component stiffnesses", () => {
  ...
  it("two-node spring has equal/opposite forces and rigid-body invariance", () => {
  ...
  it("rejects negative stiffness while permitting explicit zero components", () => {
  ...
  it("explicit spring basis rotates component stiffness", () => {
